...
import { DefaultContext, EventObject, interpret, StateMachine, TypegenDisabled } from "xstate";

// FROM: https://codesandbox.io/s/xstate-solid-example-dgpd7?from-embed=&file=/useMachine.js:0-1088
...
export default function useMachine(machine: StateMachine<DefaultContext, any, EventObject, { value: any; context: DefaultContext; }, any, any, TypegenDisabled>, options = {}) {
